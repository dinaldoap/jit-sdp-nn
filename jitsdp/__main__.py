...
def main():
    ...
    parser.add_argument('--start',   type=int, help='First commit to be used for testing (default: 1000). A minimum of one fold is not used despite this parameter.',    default=1000)
    ...
    parser.add_argument('--fold_size',   type=int, help='Number of commits in each fold (default: 50).',    default=50)
    parser.add_argument('--datasets',   type=str, help='Datasets to run the experiment. (default: brackets).', default=['brackets'], choices=['brackets', 'fabric8', 'neutron'], nargs='+')
